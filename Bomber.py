...
def infinite(pn, dl, ch, max):
    ...
    while True:
        ...
        count_inf += 1
        # os.system('echo AryanBomber >> count.xxx')
        time.sleep(float(dl))
        if (count_inf > maxlim):
            exit()
...
def checkinternet():
    ...
    if res:
        ...
        print('\t\tAryanBomber Will Stop Now...\n\n')
        banner()
        exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update AryanBomber')
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To devilsocietyabaddon@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        print("==================================================================")
        ...
        print("==================================================================")
        print("              
        print("            This Sms Bomber Was Created By Aryan Anshuman !!                ")
        print("==================================================================")
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/AryanBomber/Bomber/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/AryanBomber/Bomber/master/.version").read().decode('utf-8')
verl = ''
try:
...
print('\n\n\t\t\tStarting AryanBomber...\n\n')
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/AryanBomber/Bomber/master/.notify").read().decode('utf-8')
...
if nm == 0:
    ...
    print("==================================================================")
    print("          
    print("           This Bomber Was Created By Aryan Anshuman !!                ")
    print("==================================================================")
